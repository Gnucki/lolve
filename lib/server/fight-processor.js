 ...
 * @interface {fightProcessor}
 */
FightProcessor.prototype.chooseSummoner = function(number, fight, player) {
    var team,
        opponentTeam
    ;
    ...
    if (
        opponentTeam &&
        opponentTeam[phase] &&
        opponentTeam[phase].summoner === number
    ) {
        return;
    }
